...
## Master Roadmap
- [x] Initialisation du projet (Vanilla HTML/CSS/JS Premium)
- [x] Mise en place du Design System (Tailwind, Glassmorphism, Modern Typography)
- [x] Implémentation du layout "Carte de Présentation"
- [x] Intégration du contenu complet (CV, Expériences, Formations)
- [x] Vérification UI/UX & Responsive
- [x] Déclinaison : Version Branded Actemium (Bleu/Lime)
